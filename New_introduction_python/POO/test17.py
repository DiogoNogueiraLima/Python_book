...
class StringUtil:
    ...
    def is_palindrome(s, case_insensitive=True):
        ...
        s = ''.join(c for c in s if c.isalnum()) # Study
...
print(StringUtil.is_palindrome('Radar', case_insensitive=False)) # False: Case Sensi
print(StringUtil.is_palindrome('A nut for a jar of tuna'))
print(StringUtil.is_palindrome('Never Odd, Or Even!')) #
print(StringUtil.is_palindrome('In Girum Imus Nocte Et Consumimur Igni')) # True
